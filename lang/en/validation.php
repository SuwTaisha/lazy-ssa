...
return [
    ...
    | validator class. Một số rule có nhiều phiên bản khác nhau như các rule
    | về kích thước (size). Bạn có thể tùy chỉnh các thông báo này tại đây.
    |
    */
    ...
    'array' => 'Trường :attribute phải là một mảng (array).',
    ...
    'boolean' => 'Trường :attribute phải có giá trị đúng hoặc sai (true/false).',
    ...
    'hex_color' => 'Trường :attribute phải là một mã màu hexa hợp lệ.',
    ...
    'list' => 'Trường :attribute phải là một danh sách (list).',
    ...
    'missing_with' => 'Trường :attribute phải không được tồn tại khi có :values.',
    'missing_with_all' => 'Trường :attribute phải không được tồn tại khi có :values.',
    ...
    'password' => [
        ...
        'uncompromised' => ':attribute đã cho đã bị lộ trong một vụ rò rỉ dữ liệu. Vui lòng chọn :attribute khác.',
    ],
    ...
    'present_with_all' => 'Trường :attribute phải được cung cấp khi có :values.',
    'prohibited' => 'Trường :attribute không được phép có.',
    'prohibited_if' => 'Trường :attribute không được phép có khi :other là :value.',
    'prohibited_if_accepted' => 'Trường :attribute không được phép có khi :other được chấp nhận.',
    'prohibited_if_declined' => 'Trường :attribute không được phép có khi :other bị từ chối.',
    'prohibited_unless' => 'Trường :attribute không được phép có trừ khi :other nằm trong :values.',
    ...
    |--------------------------------------------------------------------------
    |
    | Tại đây bạn có thể chỉ định các thông báo validate tùy chỉnh cho từng
    | thuộc tính bằng cách sử dụng cú pháp "attribute.rule". Cách này giúp
    | bạn nhanh chóng chỉ định một dòng ngôn ngữ tùy chỉnh cho một rule cụ
    | thể của một thuộc tính.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau đây được dùng để thay thế placeholder thuộc tính
    | bằng một tên dễ đọc hơn, ví dụ "Địa chỉ Email" thay vì "email". Điều
    | này giúp thông báo của chúng ta trở nên rõ ràng hơn.
    |
    */
